  ...
  return (
      <div className="w-full flex flex-col">
        ...
        <div className="flex ml-10 mt-6">
          ...
          {/* Add mr-20 to create a big space */}
          <div className="ml-auto" />

          {/*<Link*/}
          {/*    href="/login"*/}
          {/*    className="bg-foreground ml-32 py-3 px-6 rounded-lg font-mono text-sm text-background"*/}
          {/*>*/}
        ...
        <div className="animate-in flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground">
          ...
          <div className="flex flex-col items-center mb-4 lg:mb-12">
            ...
            <p className="text-2xl lg:text-3xl !leading-tight mx-auto max-w-xl my-12">
              ...
              <strong>groundbreaking technology</strong> here at <strong>Envius</strong>
            </p>
